 ...
 */
export const standardBookSchema = z.object({ "name": z.string(), "buffs": z.array(z.lazy(() => buffSchema)), "level": z.number().int().min(1).max(4) }).describe("Standard Books that can be added to a General") as z.ZodType<StandardBook>;
