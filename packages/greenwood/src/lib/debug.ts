...
const fileDebug: Record<string, boolean> = {
  ...
  "/components/generals/GeneralsTable.ts": false,
  "/components/generals/MayorGeneralsTable.ts": false,
  ...
  "/components/generals/PairsTable.ts": true,
  "/components/generals/tools/GeneralStats.ts": false,
  "/components/generals/WallGeneralsTable.ts": false,
  "/components/JSONBuilders/AscendingBuilderForm.ts": false,
  "/components/JSONBuilders/GeneralBuilderForm.ts": false,
  "/components/JSONBuilders/SkillBookBuilderForm.ts": false,
  ...
  "/lib/BuffSummaryService.ts": false,
  ...
  "/lib/PairingService.ts": true,
  "/lib/PairsTableColumns.ts": false,
  ...
  "/pages/Generals/Archers/Monster.ts": false,
  "/pages/Generals/Archers/PvP/Attacking.ts": false,
  "/pages/Generals/Archers/PvP/Overall.ts": false,
  "/pages/Generals/Archers/PvP/Reinforcement.ts": false,
  "/pages/Generals/Cavalry Generals/Monster.ts": false,
  "/pages/Generals/Cavalry Generals/PvP/Attacking.ts": false,
  "/pages/Generals/Cavalry Generals/PvP/Overall.ts": false,
  "/pages/Generals/Cavalry Generals/PvP/Reinforcement.ts": false,
  "/pages/Generals/comparison.ts": false,
  "/pages/Generals/details.ts": false,
  "/pages/Generals/Infantry Generals/Monster.ts": false,
  "/pages/Generals/Infantry Generals/PvP/Attacking.ts": false,
  "/pages/Generals/Infantry Generals/PvP/Overall.ts": false,
  "/pages/Generals/Infantry Generals/PvP/Reinforcement.ts": false,
  "/pages/Generals/Mayors/MayorGenerals.ts": false,
  "/pages/Generals/pair%20comparison.ts": true,
  "/pages/Generals/Siege Generals/PvP/Attacking.ts": false,
  "/pages/Generals/Siege Generals/PvP/Overall.ts": false,
  "/pages/Generals/Siege Generals/PvP/Reinforcement.ts": false,
  "/pages/Generals/Wall Generals/WallGenerals.ts": false,
  "/pages/Monsters/Simulator.ts": false,
  "/pages/Reference/Ascending Attributes/index.ts": false,
  "/pages/Reference/Generals/index.ts": false,
  "/pages/Reference/index.ts": false,
  "/pages/Reference/SkillBooks/index.ts": false,
