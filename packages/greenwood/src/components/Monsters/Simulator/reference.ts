...
export const GroundStats: BaseStats = [
  {
    tier: 1,
    troopType: constants.TroopClass.Enum["Ground Troops"],
    attack: 100,
    defense: 300,
    hp: 600,
  },
...
export const ArcherStats: BaseStats = [
  {
    tier: 1,
    troopType: constants.TroopClass.Enum["Ranged Troops"],
    attack: 130,
    defense: 100,
    hp: 250,
  },
...
export const MountedStats: BaseStats = [
  {
    tier: 1,
    troopType: constants.TroopClass.Enum["Mounted Troops"],
    attack: 220,
    defense: 100,
    hp: 400,
  },
...
export const SiegeStats: BaseStats = [
  {
    tier: 1,
    troopType: constants.TroopClass.Enum["Siege Machines"],
    attack: 100,
    defense: 50,
    hp: 100,
  },
